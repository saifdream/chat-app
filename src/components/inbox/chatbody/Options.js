...
export default function Options({info}) {
    ...
    const [editConversation, {isLoading, isSuccess}] = useEditConversationMutation();
    ...
    return (
        <form
            className="flex items-center justify-between w-full p-3 border-t border-gray-300 relative"
        ...
        >
            ...
            />
            {
                isLoading ? <p className="absolute mx-5 my-2 right-10" style={{textAlign: 'center'}}>
